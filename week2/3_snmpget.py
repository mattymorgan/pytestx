...
def main():
    ...
    my_devices = {
        "pynet_rtr1": (IP, COMMUNITY_STRING, 161)
    ...
    for device_name, snmp_device in my_devices.items():
        ...
        snmp_data = snmp_get_oid(snmp_device, oid=sys_hostname_oid)
        sys_hostname = snmp_extract(snmp_data)
        ...
        # Get actual hostname defined via SNMP

        # Display output
        #print "\nDevice = %s" % device_name
        print "\nDevice = %s" % sys_hostname
